<div class="events index">
    ...
    <div class="row">
        <div class="col-md-12">
            <?php
            echo $this->Html->link(
                    __('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;New Event'),
                    array('action' => 'add'), array('escape' => false, 'class' => 'btn btn-primary')
            );
            ?>
                ...
                <tbody>
                    <?php foreach ($events as $event): ?>
                        <tr>
                            ...
                            <td><?php echo h($event['Event']['is_featured']); ?>&nbsp;</td>
                            <td><?php echo h($event['Event']['is_visible']); ?>&nbsp;</td>
                            <td class="actions">
                                <?php
