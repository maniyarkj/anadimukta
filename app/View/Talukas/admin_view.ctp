<div class="talukas view">
    <div class="row">
        <div class="col-md-12">
            <div class="page-header">
                <h1><?php echo __('Taluka'); ?></h1>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-9">
			...
			<?php echo h($taluka['Taluka']['name']); ?>
                    ...
                    <tr>
                        ...
                        <td>
			<?php echo $this->Html->link($taluka['City']['name'], array('controller' => 'cities', 'action' => 'view', $taluka['City']['id'])); ?>
                            &nbsp;
                        </td>
                    </tr>
                    <tr>
...
<div class="related row">
	...
	<?php if (!empty($taluka['UserDetail'])): ?>
        <table cellpadding = "0" cellspacing = "0" class="table table-striped">
            <thead>
                <tr>
                    <th><?php echo __('Id'); ?></th>
            ...
            <thead>
            <tbody>
	<?php foreach ($taluka['UserDetail'] as $userDetail): ?>
                <tr>
