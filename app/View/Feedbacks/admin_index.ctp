            ...
            <table cellpadding="0" cellspacing="0" class="table table-striped">
                <thead>
                    <tr>
                        ...
                        <th><?php echo $this->Paginator->sort('subject_id', 'Subject'); ?></th>
                        <th><?php echo $this->Paginator->sort('created', 'Submitted On'); ?></th>
                        <th class="actions"></th>
                    </tr>
                </thead>
                <tbody>
                    <?php foreach ($feedback as $feedback): ?>
                        <tr>
                            ...
                            <td>
                                <?php
                                echo $this->Html->link($feedback['FeedbackSubject']['title'],
                                        array('controller' => 'feedbacksubjects', 'action' => 'view', $feedback['FeedbackSubject']['id']));
                                ?>
                            </td>
                            <td><?php echo $this->BaseText->toDateTimeText(($feedback['Feedback']['created'])); ?>&nbsp;</td>
                            <td class="actions">
                                <?php
                                echo $this->Html->link('<span class="glyphicon glyphicon-search"></span>',
                                        array('action' => 'view', $feedback['Feedback']['id']),
                                        array('escape' => false));
                                ?>
                                <?php
