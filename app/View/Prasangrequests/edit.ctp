<div class="prasangrequests form">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="page-header">
                <h1><?php echo __('Edit Prasangrequest'); ?></h1>
            </div>
        </div>
    </div>
    ...
    <div class="row">
                        ...
                        <ul class="nav nav-pills nav-stacked">
                            ...
                            <li><?php
                                echo $this->Form->postLink(__('<span class="glyphicon glyphicon-remove"></span>&nbsp;&nbsp;Delete'),
                                        array('action' => 'delete', $this->Form->value('Prasangrequest.id')),
                                        array('escape' => false),
                                        __('Are you sure you want to delete # %s?',
                                                $this->Form->value('Prasangrequest.id')));
                                ?></li>
                            <li><?php
                                echo $this->Html->link(__('<span class="glyphicon glyphicon-list"></span>&nbsp;&nbsp;List Prasangrequests'),
        ...
        <div class="col-md-9">
            ...
            <div class="form-group">
                <?php
                echo $this->Form->input('is_personal',
                        array('class' => 'form-control', 'placeholder' => 'Is Personal'));
                ?>
            </div>
            <div class="form-group">
                <?php
                echo $this->Form->input('donor_name',
            ...
            <div class="form-group">
                <?php
                echo $this->Form->input('donor_zone_id',
                        array('class' => 'form-control', 'placeholder' => 'Donor Zone Id'));
                ?>
            </div>
            <div class="form-group">
                <?php
                echo $this->Form->input('donor_center_id',
                        array('class' => 'form-control', 'placeholder' => 'Donor Center Id'));
                ?>
            </div>
            <div class="form-group">
                <?php
                echo $this->Form->input('submitted_user_id',
            ...
            <div class="form-group">
                ...
                echo $this->Form->input('status',
                        array('class' => 'form-control', 'placeholder' => 'Status'));
                ?>
            </div>
            <div class="form-group">
