...
<div class="related row">
    <div class="col-md-12">
        ...
        <?php if (!empty($center['UserDetail'])): ?>
        <table cellpadding = "0" cellspacing = "0" class="table table-striped">
            <thead>
                <tr>
                    <th><?php echo __('Id'); ?></th>
            ...
            <thead>
            <tbody>
                    <?php foreach ($center['UserDetail'] as $userDetail): ?>
                <tr>
