...
<div class="related row">
    <div class="col-md-12">
        ...
        <table cellpadding = "0" cellspacing = "0" class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="actions">
                                <?php echo $this->Html->link(__('<span class="glyphicon glyphicon-search"></span>'), array('controller' => 'districts', 'action' => 'view', $district['id']), array('escape' => false)); ?>
                                <?php echo $this->Html->link(__('<span class="glyphicon glyphicon-edit"></span>'), array('controller' => 'districts', 'action' => 'edit', $district['id']), array('escape' => false)); ?>
                                <?php echo $this->Form->postLink(__('<span class="glyphicon glyphicon-remove"></span>'), array('controller' => 'districts', 'action' => 'delete', $district['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $district['id'])); ?>
                    </td>
                </tr>
                    <?php endforeach; ?>
            </tbody>
        ...
        <div class="actions">
            <?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;New District'), array('controller' => 'districts', 'action' => 'add'), array('escape' => false, 'class' => 'btn btn-default')); ?>
        </div>
    </div><!-- end col md 12 -->
</div>
<div class="related row">
    <div class="col-md-12">
        ...
        <?php if (!empty($country['UserDetail'])): ?>
        <table cellpadding = "0" cellspacing = "0" class="table table-striped">
            <thead>
                <tr>
                    <th><?php echo __('Id'); ?></th>
            ...
            <thead>
            <tbody>
                    <?php foreach ($country['UserDetail'] as $userDetail): ?>
                <tr>
