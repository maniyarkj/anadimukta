            ...
            <table cellpadding="0" cellspacing="0" class="table table-striped">
                <thead>
                    <tr>
                        ...
                        <?php if ($status == Prasang::STATUS_WRITING
                                && $status == Prasang::STATUS_DISCARDED) { ?>
                            ...
                            <td class="actions" width="10%">
                                ...
                                if (User::isAdmin($Auth->user())) {
                                    echo $this->Form->postLink(
                                        ...
                                        array('action' => 'delete', $prasang['Prasang']['id']),
                                        array('escape' => false , 'title' => 'Delete'),
                                        __('Are you sure you want to delete # %s?', $prasang['Prasang']['id'])
                                    );
                                }
                                ?>
                            </td>
