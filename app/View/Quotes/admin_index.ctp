<div class="quotes index">
    ...
    <div class="row">
        <div class="col-md-12">
            <?php
            echo $this->Html->link(
                    __('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;New Quote'),
                    array('action' => 'add'),
                ...
                <tbody>
                    <?php foreach ($quotes as $quote): ?>
                        <tr>
                            ...
                            <td><?php echo h($quote['Quote']['by']); ?>&nbsp;</td>
                            <td><?php echo h($quote['Quote']['is_featured']); ?>&nbsp;</td>
                            <td><?php echo h($quote['Quote']['is_visible']); ?>&nbsp;</td>
                            <td class="actions">
                                <?php
